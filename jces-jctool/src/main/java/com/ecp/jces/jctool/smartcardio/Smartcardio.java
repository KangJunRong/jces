...
import com.ecp.jces.jctool.smartcardio.Winscard.Dword;
import com.ecp.jces.jctool.smartcardio.Winscard.DwordByReference;
import com.ecp.jces.jctool.smartcardio.Winscard.SCardReaderState;
...
public class Smartcardio extends Provider {
	...
	public static final String PROVIDER_NAME = "JCES-PCSC";
	
	public Smartcardio() {
		super(PROVIDER_NAME, 0.2d, "JCES-to-PCSC Provider");
	...
	public static class JnaCardTerminals extends CardTerminals {
		 ...
		 * {@link #zombieReaders}.
		 * <li>If any change is made, {@link # known Readers Changed} is set so
