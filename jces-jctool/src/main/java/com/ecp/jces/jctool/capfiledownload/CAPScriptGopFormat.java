...
public class CAPScriptGopFormat extends CAP{
	...
	public CAPScriptGopFormat(List cmdList, String capPath, PrintWriter log, ResourceBundle msg, String pkgName, byte[] cmaid) throws IOException {
