...
public class IPWhiteListUtil {
    ...
    public static void main(String[] args) {
        String ipWhiteList = "1.168.1.1;" //设置单个IP的白名单 //
                + "192.*; " //设置ip通配符,对一个ip段进行匹配
                + "192.168.3.17-192.168.3.38; " //设置一个IP范围
                + "25.168.4.0/24 "; //设置一个网段


        System.out.println(IPWhiteListUtil.isPermited("10.10.3.15",ipWhiteList));//false
    }
}
